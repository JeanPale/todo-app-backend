...
class CategoryService:
    ...
    def create_category(
        self, category_to_create: CategoryCreateSchema
    ) -> CategorySchema:
        category_orm = self.category_repository.create(
            name=category_to_create.name
        )
    ...
    def update_category(
        self, category_id: str, category_to_update: CategoryUpdateSchema
    ) -> CategorySchema:
        category_to_update_orm = self.category_repository.get_by_id(
    ...
    def delete_category(self, category_id: str) -> None:
        category_to_delete_orm = self.category_repository.get_by_id(
            category_id=category_id
        )
