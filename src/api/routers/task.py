...
def create_task(
    payload: TaskCreateSchema, task_service: TaskServiceDep
) -> TaskSchema:
...
def update_task(
    task_id: str, payload: TaskUpdateSchema, task_service: TaskServiceDep
) -> TaskSchema:
    try:
        return task_service.update_task(
            task_id=task_id, task_to_update=payload
        )
    except TaskNotFound:
